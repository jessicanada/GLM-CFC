function [XX,P,Vlo,Vhi,t] = new_simfun(modulation_level,fixed_val)
%INPUTS:
...
%Vhi = Vhi.*(1+modulation_level*s); %Changed to pink method from GLM (06/19/18)
...
[XX,P] = glmfun(Vlo, Vhi,'theoretical',.05);
